...
Ved å bygge min egen nettside kan jeg  sørge for at jeg ikke lar noen tredjepart spore brukerne av siden, og at jeg ikke samler inn noen form for personlige data. Siden bruker ikke informasjonskapsler. Jeg bruker [GoatCounter](https://www.goatcounter.com) (åpen kildekode), for å samle grunnleggende statistikk om besøk på siden. (Siden bruker foreløpig Google Fonts som sender IP-adresse og annen grunnleggende informasjon til Google, men uten at dette spores.) Jeg har også muligheten til å <a id="bounce" style="text-decoration: underline;">leke meg litt</a>.
