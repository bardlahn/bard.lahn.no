...
Ved å bygge min egen nettside kan jeg også sørge for at jeg ikke lar noen tredjepart spore brukerne av siden, og at jeg ikke samler inn noen form for personlige data. Siden bruker ikke informasjonskapsler. Jeg bruker verktøyet [GoatCounter](https://www.goatcounter.com) for å samle grunnleggende statistikk om besøk på siden. I tillegg bruker jeg [Parsedown](https://parsedown.org) og [Symfony Yaml](https://symfony.com/doc/current/components/yaml.html) for å håndtere Markdown-filer. Ut over dette har jeg skrevet koden for hånd, med noen innspill fra språkmodellene [NorMistral 11B](https://huggingface.co/norallm/normistral-11b-thinking) og Claude Sonnet 4.6. Full kildekode er tilgjengelig på [Github](https://github.com/bardlahn/bard.lahn.no) for dem som er interessert.
