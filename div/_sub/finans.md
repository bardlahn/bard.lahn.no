---
title: 'Finans og teknologi'
date: 2026-06-20
language: 'no'
abstract: 
type: main
routes:
  canonical: /div/finans/
  languages:
    en: /div/finance/
---

**Jeg er interessert i hvordan finansiell verdsetting foregår, og hvordan finans påvirker demokratisk politikk.**

Interessen for de teknologiske og politiske sidene av finans stammer delvis fra mitt tidligere arbeid med norsk oljepolitikk. Sammen med Kristin Asdal har jeg skrevet om hvordan Norges oljereserver fra 1980-tallet ble styrt og verdsatt som en finansiell formue. Denne formen for verdsetting var en viktig medvirkende årsak til **etableringen av oljefondet,** eller Statens Pensjonsfond Utland (SPU).
...
::sidebar
![Bilde av Norges Bank](:$url_assets:images/norgesbank-s.png)
::
